...
public class TestRunner {
  ...
  public TestPerson newTestPerson() {
    ...
    person.complianceIsolateWhenContactNotified = defaultComplianceToSelfIsolateWhenContactNotified;
    people.add(person);
    return person;
  }
  ...
  public void reportSymptomsStage() {
    run(people, Person.reportSymptoms);
    run(centralAgent, CentralAgent.receiveSymptomaticMsg);
    run(people, Person.receiveQuarantineStartOrStopAndAdministerTest);
  }
  ...
  public void doInterviews() {
    run(centralAgent, CentralAgent.startInterviews);
    run(people, Person.requestOccupancyFromPlacesVisited);
    run(places, PlaceAgent.sendOccupancy);
    run(people, Person.receiveOccupancyHistoriesAndSendToCentralAgent);
    run(centralAgent, CentralAgent.processInterviewContacts);
    run(people, Person.receiveQuarantineStartOrStopAndAdministerTest);
    run(centralAgent, CentralAgent.processInfectionStatus);
  }
