...
public class InfectionStatistics {
  ...
  public int numQuarantineInfected;
  public int numQuarantineSusceptible;
  ...
  public InfectionStatistics(
      ...
      int numSusceptible,
      int numInfected,
      int numQuarantineInfected,
      int numQuarantineSusceptible,
      int numRecovered,
      int numDead,
    ...
    this.numQuarantineInfected = numQuarantineInfected;
    this.numQuarantineSusceptible = numQuarantineSusceptible;
