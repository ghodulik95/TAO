...
public class PlaceInfo {
  ...
  public enum NetworkType {
    ...
    FULLY_CONNECTED_WITH_FLAT_INFECTION_RATE, // Anyone can infect anyone and anyone can get infected from a flat infection rate
    FLAT_INFECTION_RATE // Anyone can get infected from a flat infection rate, there are no contacts
  }
